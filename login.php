...
if (isset($_POST['cek_login'])) {
    ...
    if (empty($username) && empty($password)) {
        ...
        $admin = mysqli_query($con, "SELECT * FROM tb_admin WHERE username='$username'") or die(mysqli_error($con));
        ...
        if (mysqli_num_rows($admin) != 0) {
            ...
            $user = mysqli_query($con, "SELECT * FROM tb_user WHERE username='$username'") or die(mysqli_error($con));
...
<head>
    ...
    <title>Sistem Informasi Manajemen Inventaris</title>
    ...
    <div align="center">
        ...
        <div align="center" style="width:320px;margin-top:5%;">
            <form method="post" class="well well-lg p-5" action="" style="-webkit-box-shadow: 0px 0px 20px #888888;">
                <i class="fas fa-fw fa-file-alt fa-4x"></i>
                <h5>Selamat Datang di SIMI <br> (Sistem Informasi Manajemen Inventaris)</h5>
                <br>
                ...
                <div class="input-group ">
                    <input required name="username" id="username" class="form-control" type="text" placeholder="Username (NIM)" autocomplete="off" />
                </div>
                <br />
                <div class="input-group">
