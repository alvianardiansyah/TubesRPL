...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a href="#" class="btn btn-primary btn-icon-split btn-sm" data-toggle="modal" data-target="#barangmasukModal" onclick="submit('add', '<?= $_SESSION['id'] ?>')">
                    <span class="icon text-white-50">
                        <i class="fas fa-plus"></i>
                    </span>
                    <span class="text">Tambah</span>
                </a>
                <a href="<?= base_url(); ?>process/cetak_laporan_transaksi_barang_today.php?jenis_transaksi=masuk" target="_blank" class="btn btn-info btn-icon-split btn-sm float-right">
                    <span class="icon text-white-50">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-inline-flex p-2">
                                            <a href="#barangmasukModal" data-toggle="modal" onclick="submit(<?= $row['id_transaksi']; ?>)" class="btn btn-sm btn-circle btn-info mr-2"><i class="fas fa-edit"></i></a>
                                            <?php if ($_SESSION['role'] == 'admin') : ?>
                                                <a href="<?= base_url(); ?>/process/process_barang_masuk.php?act=<?= encrypt('delete'); ?>&id=<?= encrypt($row['id_transaksi']); ?>" class="btn btn-sm btn-circle btn-danger btn-hapus"><i class="fas fa-trash"></i></a>
                                            <?php endif; ?>
                                        </div>
                                    </td>
                                </tr>
    ...
    <div class="modal fade" id="barangmasukModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="id_barang" id="id_barang" class="form-control select2" style="width:100%;" disabled>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="id_kategori" id="id_kategori" class="form-control" style="width:100%;" disabled>
                                        <?= list_kategori(); ?>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="id_kondisi" id="id_kondisi" class="form-control" style="width:100%;" disabled>
                                        <?= list_kondisi(); ?>
                                    </select>
                                </div>
                            </div>
