                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-inline-flex p-2">
                                            <a href="#barangkeluarModal" data-toggle="modal" onclick="submit(<?= $row['id_transaksi']; ?>)" class="btn btn-sm btn-circle btn-info mr-2"><i class="fas fa-edit"></i></a>
                                            <?php if ($_SESSION['role'] == 'admin') : ?>
                                                <a href="<?= base_url(); ?>/process/process_barang_keluar.php?act=<?= encrypt('delete'); ?>&id=<?= encrypt($row['id_transaksi']); ?>" class="btn btn-sm btn-circle btn-danger btn-hapus"><i class="fas fa-trash"></i></a>
                                            <?php endif; ?>
                                        </div>
                                    </td>
                                </tr>
                ...
                <form action="<?= base_url(); ?>process/process_barang_keluar.php" method="post">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="id_kondisi">Kondisi Awal<span class="text-danger">*</span></label>
