...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Barang Inventaris</h1>
        </div>
        <!-- DataTales Example -->
                                    ...
                                    <td>
                                        <?php if ($_SESSION['role'] == 'admin') : ?>
                                            <div class="d-inline-flex p-2">
                                                <a href="#barangModal" data-toggle="modal" onclick="submit(<?= $row['id_barang']; ?>)" class="btn btn-sm btn-circle btn-info mr-2"><i class="fas fa-edit"></i></a>
                                                <a href="<?= base_url(); ?>/process/process_barang.php?act=<?= encrypt('delete'); ?>&id=<?= encrypt($row['id_barang']); ?>" class="btn btn-sm btn-circle btn-danger btn-hapus"><i class="fas fa-trash"></i></a>
                                            </div>
                                        <?php else : ?>
                                            <div class="d-inline-flex p-2">
                                                <span class="fas fa-ban"> can't access</span>
                                            </div>
                                        <?php endif; ?>
                                    </td>
                                </tr>
